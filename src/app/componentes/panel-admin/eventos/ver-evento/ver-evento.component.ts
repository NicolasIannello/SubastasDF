...
export class VerEventoComponent {
  ...
  async generarExcel(){
    ...
    "<div style='display:flex; background-color:#3083dc; color:#F9F9F9; text-align:center; font-size:x-small;'>"+
      "<div style='width:30%'; font-size:x-small;>Titulo</div>"+
      "<div style='width:15%'; font-size:x-small;>Precio base</div>"+
      "<div style='width:15%'; font-size:x-small;>Precio venta</div>"+
      "<div style='width:10%'; font-size:x-small;>Ofertas</div>"+
      ...
      this.api2.ofertaDatos(dato).subscribe({
        next:(value)=> {
            ...
            html+="<div style='display:flex'; text-align:center;>"+
              "<div style='border: 1px solid rgb(48, 131, 220, 0.2); width:30%; font-size:x-small; text-align:center;'>"+this.lotes[i]['titulo']+"</div>"+
